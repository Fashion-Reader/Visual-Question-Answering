...
MODEL_PATH = './results/train/train_v3/model.pt'
...
answer_list = pd.read_csv("./results/train/train_v3/answers.csv")['answer'].tolist()
...
pd.DataFrame({'ID': output_id, 'answer': output_pred}).to_csv('./results/train/train_v3/submission.csv', index=False)